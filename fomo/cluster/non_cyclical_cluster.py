...
class Cluster_KMeans(KMeans):
    ...
    def __init__(self, n_clusters, n_init='auto', **kwargs):
        super().__init__(n_clusters, n_init=n_init,**kwargs)

    @classmethod
    def find_n_clusters(cls, missing_data_matrix, clusters: list, method: str, show_progress=False):
        ...
        if method == 'elbow':
            ...
            for gap_index, k in enumerate(clusters_iter):
